...
2.  research — nominal (no problems)
3.  height — continuous (no problems)
4.  weight — continuous (no problems)
5.  lvst1 — ordinal (changed)
6.  lvst2 — ordinal (changed)
7.  lvst3 — ordinal (changed)
8.  lvst4 — ordinal (changed)
9.  frst1 — ordinal (changed)
10. frst2 — ordinal (changed)
11. frst3 — ordinal (changed)
...
FOSS_total range= 3-14 LOSS_total range= 6-18
...
-   How do the z-scores compare between the sum scores and the mean
    ...
    -   Answer: The z-score is how many standard deviations a score is
        from the mean.
